...
ActiveRecord::Schema.define(version: 2019_02_21_122646) do
  ...
  create_table "renovation_projects", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "name"
    t.text "address"
    t.float "latitude"
    t.float "longitude"
  ...
  create_table "requested_projects", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
